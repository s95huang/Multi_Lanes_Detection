...
SPLIT_FILES = {
    'train+val': ['label_data_0313_new.json', 'label_data_0601_new.json', 'label_data_0531_new.json'],
    'train': ['label_data_0313.json_new', 'label_data_0601_new.json'],
    'val': ['label_data_0531_new.json'],
    'test': ['test_tasks_0627_new.json'],
}
